...
export class FilesState {
  ...
  fetchFiles(): void {
    ...
    this.mediaService.fetchFiles(this.filterKeyword.value).then(value => {
  ...
  private fetchTotalFiles(): void {
    this.mediaService.totalFiles(this.filterKeyword.value).then(value => {
  ...
  uploadFile(file: File, done: () => void): void {
    ...
    this.mediaService.uploadFile(file, progress => {
